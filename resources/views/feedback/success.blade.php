...
<body class="bg-gradient-to-br from-cyan-700 to-cyan-900 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-2xl shadow-2xl p-4 sm:p-8 md:p-12 text-center max-w-md w-full mx-2">
        <!-- Removed duplicate background content, only modal will show -->
        <!-- Modal Success -->
